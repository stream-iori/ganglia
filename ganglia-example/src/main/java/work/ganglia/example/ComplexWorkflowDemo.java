    ...
    Ganglia.bootstrap(vertx)
        ...
        .onSuccess(
            ganglia -> {
              ...
              String input1 =
                  "Create a temporary file named 'complex_demo.txt' with the text 'Initial content.' using shell command.";
              ...
              runTurn(ganglia, sessionId, input1)
                  .compose(
                      context1 -> {
                        ...
                        System.out.println("\n\n--- Turn 2 ---");
                        String input2 =
                            "Append ' Second line added.' to 'complex_demo.txt', then read the file to confirm content.";
                  ...
                  .compose(
                      context2 -> {
                        ...
                        System.out.println("\n\n--- Turn 3 ---");
                        String input3 =
                            "Check if 'complex_demo.txt' exists in the current directory using ls, then delete it and confirm deletion.";
