...
/**
 * A demo showcasing Parent-Child Agent cooperation.
 * The Parent Agent delegates a messy investigation task to a Sub-Agent (Investigator),
 * then uses the high-level report to perform a calculation.
 */
    ...
    public static void main(String[] args) {
        ...
        Ganglia.bootstrap(vertx)
            ...
            .onSuccess(ganglia -> {
                ...
                System.out.println("Goal: Sum revenues from all files in '" + dataDir + "' using a Sub-Agent.");
                ...
                ganglia.sessionManager().getSession(sessionId)
                    ...
                    .onComplete(ar -> {
                        ...
                        vertx.fileSystem().deleteRecursive(dataDir)
