            ...
            .onSuccess(ganglia -> {
                ...
                ganglia.sessionManager().getSession(sessionId)
                    .onSuccess(context -> {
                        ...
                        String input = args.length > 0 ? String.join(" ", args) : "Please create a plan with 2 steps using your todo tools: 1. echo 'Hello ToDo' to a file named 'todo-test.txt'. 2. Read the file. Execute the plan step by step, and make sure to use todo_complete to mark tasks as done as you progress.";
                        System.out.println("\nUser: " + input);
