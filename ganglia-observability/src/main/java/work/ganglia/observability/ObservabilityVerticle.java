...
import work.ganglia.observability.metrics.MetricAggregator;
import work.ganglia.observability.metrics.MetricsHandler;
...
public class ObservabilityVerticle extends AbstractVerticle {
  ...
  public void start(Promise<Void> startPromise) {
    metricAggregator = new MetricAggregator(vertx);
  ...
  private Router setupRouter() {
    ...
    // API Endpoints
    router.get("/api/metrics").handler(new MetricsHandler(metricAggregator));
    ...
    String resolvedWebroot =
        webroot != null && Files.isDirectory(Path.of(webroot)) ? webroot : "webroot";
