...
- [ ] T001 Create project structure per implementation plan (Hexagonal Layers)
- [ ] T002 Initialize [language] project with [framework] dependencies
- [ ] T003 [P] Configure linting and formatting tools
- [ ] T004 Verify Hexagonal Layer alignment (Kernel/Port/Infra separation)
- [ ] T005 [P] Setup Memory synchronization task (ensure state is reflected in MEMORY.md)
