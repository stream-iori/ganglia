...
public class FileSystemDailyRecordManagerTest {
    ...
    @Test
    public void testRecordCreatesDirectoryAndFile(Vertx vertx, VertxTestContext testContext, @TempDir Path tempDir) {
        ...
        manager.record("session-1", "My Goal", "My Accomplishments")
            .compose(v -> {
