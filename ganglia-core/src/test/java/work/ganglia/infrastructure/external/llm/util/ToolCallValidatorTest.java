...
class ToolCallValidatorTest {
  ...
  static Stream<Arguments> validationProvider() {
    ...
    return Stream.of(
        ...
        arguments(
            baseSchema, Map.of("other", 10), "required", "Should detect missing required field"),
        arguments(
            baseSchema, Map.of("count", "not a number"), "string", "Should detect wrong type"));
  }
  ...
  void testValidate(
      String schema, Map<String, Object> args, String expectedErrorSub, String description) {
