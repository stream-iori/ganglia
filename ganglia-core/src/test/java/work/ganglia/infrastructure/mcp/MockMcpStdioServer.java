        ...
        try (BufferedReader reader = new BufferedReader(new InputStreamReader(System.in, StandardCharsets.UTF_8))) {
            ...
            while ((line = reader.readLine()) != null) {
                if (line.contains("\"method\":\"initialize\"")) {
                    ...
                    String response = "{\"jsonrpc\":\"2.0\",\"id\":" + id + ",\"result\":{\"protocolVersion\":\"2025-11-25\",\"capabilities\":{},\"serverInfo\":{\"name\":\"MockStdio\",\"version\":\"1.0\"}}}";
                    System.out.println(response);
                    System.out.flush();
                } else if (line.contains("\"method\":\"tools/list\"")) {
                    String id = extractId(line);
                    String response = "{\"jsonrpc\":\"2.0\",\"id\":" + id + ",\"result\":{\"tools\":[{\"name\":\"mockTool\",\"description\":\"A mock tool\",\"inputSchema\":{}}]}}";
                    System.out.println(response);
                    System.out.flush();
