...
public class FileSystemUtilTest {
    ...
    @Test
    public void testEnsureDirectoryExists(Vertx vertx, VertxTestContext testContext, @TempDir Path tempDir) {
    ...
    @Test
    public void testEnsureNestedDirectoryExists(Vertx vertx, VertxTestContext testContext, @TempDir Path tempDir) {
    ...
    @Test
    public void testEnsureFileWithDefault(Vertx vertx, VertxTestContext testContext, @TempDir Path tempDir) {
    ...
    @Test
    public void testEnsureFileWithBufferDefault(Vertx vertx, VertxTestContext testContext, @TempDir Path tempDir) {
