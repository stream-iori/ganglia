...
/**
 * Provides execution context for tools and other components, allowing them to report progress
 * and errors without depending on underlying infrastructure (e.g., Vert.x EventBus).
 */
