...
public interface SkillRuntime {
    /**
     * Activates a skill for the given context.
     * Returns a new context with the skill added to active IDs.
     */
     ...
     */
    List<me.stream.ganglia.tools.ToolSet> getActiveSkillsTools(SessionContext context);
