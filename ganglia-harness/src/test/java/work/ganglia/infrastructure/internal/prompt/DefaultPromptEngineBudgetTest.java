...
class DefaultPromptEngineBudgetTest extends BaseGangliaTest {
  ...
  private DefaultPromptEngine createEngine(int contextLimit, int maxTokens) {
    ...
    return new DefaultPromptEngine(
        vertx,
        memoryService,
        skillRuntime,
        null,
  ...
  void budgetDerivedFromModelConfig() {
    DefaultPromptEngine engine = createEngine(128000, 4096);
  ...
  void budgetDerivedFromSmallWindow() {
    DefaultPromptEngine engine = createEngine(8000, 1000);
    ContextBudget budget = engine.getBudget();
  ...
  void budgetDerivedFromLargeWindow() {
    DefaultPromptEngine engine = createEngine(200000, 4096);
    ContextBudget budget = engine.getBudget();
