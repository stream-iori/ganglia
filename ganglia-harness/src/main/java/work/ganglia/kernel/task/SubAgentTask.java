...
public class SubAgentTask implements AgentTask {
  ...
  public Future<AgentTaskResult> execute(
    ...
    // Build prompt: optional MISSION prefix, then TASK
    StringBuilder promptBuilder = new StringBuilder();
    Object missionContext = parentContext.metadata().get("mission_context");
    if (missionContext != null) {
      promptBuilder.append("MISSION: ").append(missionContext).append("\n\n");
    }
    promptBuilder.append("TASK: ").append(task);
