...
/**
 * Context source that provides the memory index for progressive disclosure. Renamed from
 * MemoryContextSource to avoid collision with the prompt-layer MemoryContextSource.
 */
public class MemoryIndexContextSource implements ContextSource {

  private final MemoryStore memoryStore;

  public MemoryIndexContextSource(MemoryStore memoryStore) {
