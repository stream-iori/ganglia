...
public class LongTermKnowledgeModule implements MemoryModule {
  ...
  public Future<List<ContextFragment>> provideContext(SessionContext context) {
    String content =
        """
                - You have access to a persistent project knowledge base (.ganglia/memory/MEMORY.md).
                - Use the 'remember' tool to save important facts, conventions, or architectural decisions.
                - Use 'grep' or 'read' to search .ganglia/memory/ if you need to recall project or user context.
                """;
