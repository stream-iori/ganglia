...
public record Message(
   ...
   *     ObservationCompressionHook; prevents a second truncation pass in DefaultPromptEngine.
   */
   ...
   * {@code DefaultPromptEngine} will skip the redundant truncation pass for such messages.
   */
