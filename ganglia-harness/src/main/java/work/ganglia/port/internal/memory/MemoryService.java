...
/**
 * Background service that acts as a registry and event dispatcher for memory modules. Listens for
 * memory events on the EventBus and delegates to registered modules.
 */
