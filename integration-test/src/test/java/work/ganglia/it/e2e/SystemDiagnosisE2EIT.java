...
public class SystemDiagnosisE2EIT {
  ...
  void testSystemDiagnosis(Vertx vertx, VertxTestContext testContext, @TempDir Path tempDir) {
    vertx
        .fileSystem()
        .writeFileBlocking(
            tempDir.resolve("task1.java").toString(), Buffer.buffer("// TODO: Fix this"));
    vertx
        .fileSystem()
        .writeFileBlocking(
            tempDir.resolve("task2.java").toString(), Buffer.buffer("// TODO: And this"));

    ToolCall grepCall =
        new ToolCall("c1", "grep_search", Map.of("path", tempDir.toString(), "pattern", "TODO"));
    ...
    TestScenario scenario =
        new TestScenario(
            ...
            List.of(
                new ModelResponse(
                    "Searching for TODOs...", List.of(grepCall), new TokenUsage(1, 1)),
                new ModelResponse(
                    "I found TODOs in task1.java and task2.java.",
