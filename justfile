...
frontend_dir := "coding-agent/ganglia-coding-webui"
...
test-backend:
    mvn test -pl ganglia-harness,ganglia-local-file-memory,coding-agent/ganglia-coding,coding-agent/ganglia-coding-web,coding-agent/ganglia-terminal,ganglia-observability
...
_run-coverage:
    mvn spotless:apply test -pl ganglia-harness,ganglia-local-file-memory,coding-agent/ganglia-coding,coding-agent/ganglia-coding-web,coding-agent/ganglia-terminal,ganglia-observability
