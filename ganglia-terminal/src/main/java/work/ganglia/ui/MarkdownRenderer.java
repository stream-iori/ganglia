...
public class MarkdownRenderer {
    ...
    private static final AttributedStyle CODE_LABEL =
            AttributedStyle.DEFAULT.faint().background(236);
    private static final AttributedStyle INLINE_CODE =
            AttributedStyle.DEFAULT.foreground(AttributedStyle.YELLOW).background(AttributedStyle.BLACK + 8);
    private static final AttributedStyle CHECKED_STYLE =
            AttributedStyle.DEFAULT.foreground(AttributedStyle.GREEN);
    private static final AttributedStyle CHECKED_TEXT_STYLE =
            CHECKED_STYLE.faint();
    ...
    private void renderListItem(ListItem listItem, AttributedStringBuilder sb, AttributedStyle style) {
    ...
    private void renderCheckboxItem(ListItem listItem, AttributedStringBuilder sb,
                                    AttributedStyle style, CheckboxResult checkbox) {
    ...
    /**
     * Renders a code block with dark gray background (256-color 236).
     * Shows an optional language label on the first line.
     */
    ...
    /**
     * Detects checkbox syntax in a ListItem. CommonMark parses "- [ ] text" as
     * ListItem > Paragraph > Text("[ ] text"). Returns null if no checkbox found.
     */
    private CheckboxResult detectCheckbox(Node listItem) {
        ...
        } else if (lit.startsWith("[x] ") || lit.startsWith("[X] ")
                || "[x]".equals(lit) || "[X]".equals(lit)) {
