...
/**
 * It wraps the core bootstrap process and automatically injects all coding tools and context sources.
 */
public class CodingAgentBuilder {
    ...
    public static Future<Ganglia> bootstrap(Vertx vertx, BootstrapOptions baseOptions) {
        String projectRoot = baseOptions.projectRoot() != null ? baseOptions.projectRoot() : System.getProperty("user.dir");
